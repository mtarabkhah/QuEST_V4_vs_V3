...
int main (int narg, char *varg[]) {
	...
	applyHadamard(qubits, 18);
	applyHadamard(qubits, 19);
	...
	applyTwoQubitPhaseShift(qubits, 18, 0, 1.1984224905356572e-05);
	applyTwoQubitPhaseShift(qubits, 19, 0, 5.992112452678286e-06);
	applyHadamard(qubits, 1);
	...
	applyTwoQubitPhaseShift(qubits, 18, 1, 2.3968449810713143e-05);
	applyTwoQubitPhaseShift(qubits, 19, 1, 1.1984224905356572e-05);
	applyHadamard(qubits, 2);
	...
	applyTwoQubitPhaseShift(qubits, 18, 2, 4.7936899621426287e-05);
	applyTwoQubitPhaseShift(qubits, 19, 2, 2.3968449810713143e-05);
	applyHadamard(qubits, 3);
	...
	applyTwoQubitPhaseShift(qubits, 18, 3, 9.587379924285257e-05);
	applyTwoQubitPhaseShift(qubits, 19, 3, 4.7936899621426287e-05);
	applyHadamard(qubits, 4);
	...
	applyTwoQubitPhaseShift(qubits, 18, 4, 0.00019174759848570515);
	applyTwoQubitPhaseShift(qubits, 19, 4, 9.587379924285257e-05);
	applyHadamard(qubits, 5);
	...
	applyTwoQubitPhaseShift(qubits, 18, 5, 0.0003834951969714103);
	applyTwoQubitPhaseShift(qubits, 19, 5, 0.00019174759848570515);
	applyHadamard(qubits, 6);
	...
	applyTwoQubitPhaseShift(qubits, 18, 6, 0.0007669903939428206);
	applyTwoQubitPhaseShift(qubits, 19, 6, 0.0003834951969714103);
	applyHadamard(qubits, 7);
	...
	applyTwoQubitPhaseShift(qubits, 18, 7, 0.0015339807878856412);
	applyTwoQubitPhaseShift(qubits, 19, 7, 0.0007669903939428206);
	applyHadamard(qubits, 8);
	...
	applyTwoQubitPhaseShift(qubits, 18, 8, 0.0030679615757712823);
	applyTwoQubitPhaseShift(qubits, 19, 8, 0.0015339807878856412);
	applyHadamard(qubits, 9);
	...
	applyTwoQubitPhaseShift(qubits, 18, 9, 0.006135923151542565);
	applyTwoQubitPhaseShift(qubits, 19, 9, 0.0030679615757712823);
	applyHadamard(qubits, 10);
	...
	applyTwoQubitPhaseShift(qubits, 18, 10, 0.01227184630308513);
	applyTwoQubitPhaseShift(qubits, 19, 10, 0.006135923151542565);
	applyHadamard(qubits, 11);
	...
	applyTwoQubitPhaseShift(qubits, 18, 11, 0.02454369260617026);
	applyTwoQubitPhaseShift(qubits, 19, 11, 0.01227184630308513);
	applyHadamard(qubits, 12);
	...
	applyTwoQubitPhaseShift(qubits, 18, 12, 0.04908738521234052);
	applyTwoQubitPhaseShift(qubits, 19, 12, 0.02454369260617026);
	applyHadamard(qubits, 13);
	...
	applyTwoQubitPhaseShift(qubits, 18, 13, 0.09817477042468103);
	applyTwoQubitPhaseShift(qubits, 19, 13, 0.04908738521234052);
	applyHadamard(qubits, 14);
	...
	applyTwoQubitPhaseShift(qubits, 18, 14, 0.19634954084936207);
	applyTwoQubitPhaseShift(qubits, 19, 14, 0.09817477042468103);
	applyHadamard(qubits, 15);
	applyTwoQubitPhaseShift(qubits, 16, 15, 1.5707963267948966);
	applyTwoQubitPhaseShift(qubits, 17, 15, 0.7853981633974483);
	applyTwoQubitPhaseShift(qubits, 18, 15, 0.39269908169872414);
	applyTwoQubitPhaseShift(qubits, 19, 15, 0.19634954084936207);
	applyHadamard(qubits, 16);
	applyTwoQubitPhaseShift(qubits, 17, 16, 1.5707963267948966);
	applyTwoQubitPhaseShift(qubits, 18, 16, 0.7853981633974483);
	applyTwoQubitPhaseShift(qubits, 19, 16, 0.39269908169872414);
	applyHadamard(qubits, 17);
	applyTwoQubitPhaseShift(qubits, 18, 17, 1.5707963267948966);
	applyTwoQubitPhaseShift(qubits, 19, 17, 0.7853981633974483);
	applyHadamard(qubits, 18);
	applyTwoQubitPhaseShift(qubits, 19, 18, 1.5707963267948966);
	applyHadamard(qubits, 19);
	...
	char dynamicFileName[] = "_QC_QFT_H_20_QuEST_V4.csv";
